...
\hitsetup{
  ...
  %
  % 关键词用“英文逗号”分割
  ckeywords={代码质量, 变更影响分析, 检索增强生成, 代码度量, 代码结构可视化, 代码审查图},
  ekeywords={code quality, change impact analysis, retrieval-augmented generation,  code metrics, code structure visualization, code review graph},
}
